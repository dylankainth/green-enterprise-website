<template>
  <div class="wrapper">
    <header>
      <div class="container">
        <nav class="navbar navbar-light d-flex flex-wrap justify-content-center">
          <a
            href="/"
...
.content {
  /* margin-top: 160px; /* Change the value to the height of the navbar */
  flex-grow: 1;
}
